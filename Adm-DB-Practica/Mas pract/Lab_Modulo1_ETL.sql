...
DELIMITER $$
CREATE DEFINER=`root`@`localhost` FUNCTION `UC_Words`( str VARCHAR(255) ) 
...
LOAD DATA INFILE 'C:\\xampp\\tmp\\gasto.csv' 
INTO TABLE `gasto` 
...
LOAD DATA INFILE 'C:\\xampp\\tmp\\compra.csv' 
INTO TABLE `compra` 
FIELDS TERMINATED BY ';' ENCLOSED BY '' ESCAPED BY '' 
LINES TERMINATED BY '\n' IGNORE 1 LINES;
...
LOAD DATA INFILE 'C:\\xampp\\tmp\\venta.csv' 
INTO TABLE `venta` 
FIELDS TERMINATED BY ';' ENCLOSED BY '' ESCAPED BY '' 
LINES TERMINATED BY '\n' IGNORE 1 LINES;
...
LOAD DATA INFILE 'C:\\xampp\\tmp\\CanalDeVenta.csv' 
...
LOAD DATA INFILE 'C:\\xampp\\tmp\\TiposDeGasto.csv' 
...
LOAD DATA INFILE 'C:\\xampp\\tmp\\Clientes.csv'
INTO TABLE cliente
FIELDS TERMINATED BY ';' ENCLOSED BY '\"' ESCAPED BY '\"' 
LINES TERMINATED BY '\n' IGNORE 1 LINES;
...
LOAD DATA INFILE 'C:\\xampp\\tmp\\Proveedores.csv' 
...
LOAD DATA INFILE 'C:\\xampp\\tmp\\Productos.csv' 
INTO TABLE `producto` 
FIELDS TERMINATED BY ';' ENCLOSED BY '\"' ESCAPED BY '\"' 
LINES TERMINATED BY '\n' IGNORE 1 LINES;
...
LOAD DATA INFILE 'C:\\xampp\\tmp\\Empleados.csv' 
INTO TABLE `empleado` 
FIELDS TERMINATED BY ';' ENCLOSED BY '\"' ESCAPED BY '\"' 
LINES TERMINATED BY '\n' IGNORE 1 LINES;
...
LOAD DATA INFILE 'C:\\xampp\\tmp\\Sucursales.csv' 
INTO TABLE sucursal
FIELDS TERMINATED BY ';' ENCLOSED BY '\"' ESCAPED BY '\"' 
LINES TERMINATED BY '\n' IGNORE 1 LINES;
